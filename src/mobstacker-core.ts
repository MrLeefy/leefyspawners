...
export { spawnerStatistics, calculateSpawnerTotals, updateSpawnerStatistics, updateSpawnerMetadata, performanceMetrics, getMemoryUsage, saveSpawnerStatistics, loadSpawnerStatistics, resetSpawnerStatistics, getPlayerTopKills, ACTIVE_CHUNKS, enableLogging, disableLogging, isLoggingEnabled, debugLog };