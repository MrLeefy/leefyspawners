export class Vector3 {
     ...
     */
    static Add(pos1: Vector3, pos2: Vector3): Vector3 {
     ...
     */
    static Subtract(pos1: Vector3, pos2: Vector3): Vector3 {
        return new Vector3(pos1.x - pos2.x, pos1.y - pos2.y, pos1.z - pos2.z);
    }
     ...
     */
    static Divide(pos1: Vector3, pos2: Vector3): Vector3 {
        return new Vector3(pos1.x / pos2.x, pos1.y / pos2.y, pos1.z / pos2.z);
    }
     ...
     */
    static Scale(pos1: Vector3, num: number): Vector3 {
     ...
     */
    static Multiply(pos1: Vector3, pos2: Vector3): Vector3 {
        return new Vector3(pos1.x * pos2.x, pos1.y * pos2.y, pos1.z * pos2.z);
    }
     ...
     */
    static Equals(pos1: Vector3, pos2: Vector3, tolerance?: number): boolean {
     ...
     */
    static Lerp(pos1: Vector3, pos2: Vector3, tParam: number): Vector3 {
     ...
     */
    static Dot(pos1: Vector3, pos2: Vector3): number {
        return pos1.x * pos2.x + pos1.y * pos2.y + pos1.z * pos2.z;
    }
     ...
     */
    static Cross(pos1: Vector3, pos2: Vector3): Vector3 {
     ...
     */
    static Magnitude(pos: Vector3): number {
     ...
     */
    static SqrMagnitude(pos: Vector3): number {
     ...
     */
    static SqrDistance(pos1: Vector3, pos2: Vector3): number {
        const dx = pos2.x - pos1.x;
        const dy = pos2.y - pos1.y;
        const dz = pos2.z - pos1.z;
     ...
     */
    static Normalize(dir: Vector3): Vector3 {
...
export class Vector2 {
     ...
     */
    static Add(pos1: Vector2, pos2: Vector2): Vector2 {
     ...
     */
    static Subtract(pos1: Vector2, pos2: Vector2): Vector2 {
        return new Vector2(pos1.x - pos2.x, pos1.y - pos2.y);
    }
     ...
     */
    static Divide(pos1: Vector2, pos2: Vector2): Vector2 {
        return new Vector2(pos1.x / pos2.x, pos1.y / pos2.y);
    }
     ...
     */
    static Scale(pos1: Vector2, scale: number): Vector2 {
     ...
     */
    static Multiply(pos1: Vector2, pos2: Vector2): Vector2 {
        return new Vector2(pos1.x * pos2.x, pos1.y * pos2.y);
    }
     ...
     */
    static Equals(pos1: Vector2, pos2: Vector2, tolerance?: number): boolean {
        if (tolerance === undefined) {
     ...
     */
    static Distance(pos1: Vector2, pos2: Vector2): number {
     ...
     */
    static Lerp(pos1: Vector2, pos2: Vector2, tParam: number): Vector2 {
        const x = pos1.x + (pos2.x - pos1.x) * tParam;
        const y = pos1.y + (pos2.y - pos1.y) * tParam;
     ...
     * Gets the dot product of 2 vectors
     */
    static Dot(pos1: Vector2, pos2: Vector2): number {
        return pos1.x * pos2.x + pos1.y * pos2.y;
    }
     ...
     * Gets the magnitude of a vector
     */
    static Magnitude(pos: Vector2): number {
     ...
     * Gets the square magnitude of a vector
     */
    static SqrMagnitude(pos: Vector2): number {
     ...
     * Gets the squared distance between 2 vectors
     */
    static SqrDistance(pos1: Vector2, pos2: Vector2): number {
        const dx = pos2.x - pos1.x;
        const dy = pos2.y - pos1.y;
        return dx * dx + dy * dy;
    }
     ...
     * Normalizes the vector
     */
    static Normalize(dir: Vector2): Vector2 {
...
export class Mathf {
     ...
     */
    static Lerp(a: number, b: number, tParam: number): number {
        return a + (b - a) * tParam;
    }
 ...
 */
export function GetMinMax(pos1: Vector3, pos2: Vector3): Vector3[] {
